...
| 3 | Kanban | Markdown task board, persistent filters, saved board views, and drag-to-review status proposals | Richer status vocabulary and multi-board persistence beyond local settings |
