...
| 2 | Editor and keyboard workflow | Byte-preserving textarea, keyboard shortcuts, dependency-free accessible Markdown toolbar, conservative bounded scalar-list frontmatter values, and reviewable list-property editing | Syntax-preserving editor, large-note UI sessions, and keyboard audit |
