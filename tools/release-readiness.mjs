...
check("INTERACTIVE_CANVAS_REVIEW", existsSync(resolve(root, "app/public/canvas-ui.js")) && read("app/public/canvas-ui.js").includes("Download proposal"), "Canvas mouse/keyboard movement emits review-only JSON proposals; direct source writes remain disabled.");
