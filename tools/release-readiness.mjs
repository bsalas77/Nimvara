...
check("DIAGNOSTICS_REPORT", read("app/server/lantern-core.mjs").includes("diagnosticsReport") && read("app/server/index.mjs").includes("/api/diagnostics") && existsSync(resolve(root, "app/tests/diagnostics.test.mjs")), "Support diagnostics are aggregate-only, omit note contents and identifying paths, and are covered by an automated redaction test.");
