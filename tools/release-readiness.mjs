...
check("SEARCH_PERFORMANCE", existsSync(resolve(root, "implementation/PERFORMANCE-EVIDENCE-2026-08-30.md")), "Release benchmark evidence is recorded for 10,000 synthetic notes (1,176 ms create; 8,687 ms cold index; 1,095 ms incremental reopen; 1,704 microseconds warm search) plus a long-note/attachment fixture. Real-vault measurements remain required.");
