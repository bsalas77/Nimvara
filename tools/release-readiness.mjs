...
check("SAFE_STATIC_PUBLISHING", read("app/src-tauri/src/native_core.rs").includes("safe-static-html-v1") && read("app/public/app.js").includes("/api/publishing/export"), "Selected/all-note static HTML export is available through the native desktop path and UI; link rewriting and archive packaging remain open.");
