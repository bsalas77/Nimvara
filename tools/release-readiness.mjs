...
check("CANVAS_HISTORY", read("app/src-tauri/src/native_core.rs").includes("checkpoint(root, &normalized") && read("app/src-tauri/src/native_core.rs").includes("clean_canvas_relative"), "Approved Canvas saves create a local checkpoint and Canvas history entries can be restored through the same validated native path.");
