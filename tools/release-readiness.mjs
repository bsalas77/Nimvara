...
check("TYPED_PROPERTY_VIEWS", read("app/public/productivity.js").includes("export function parseScalar") && existsSync(resolve(root, "app/tests/typed-properties.test.mjs")), "Conservative boolean and finite-number frontmatter parsing is covered by filtering and sorting tests.");
