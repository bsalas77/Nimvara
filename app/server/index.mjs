...
export const server = createServer(async (request, response) => {
  ...
  try {
    ...
    if (request.method === "GET" && url.pathname === "/api/status") return send(response, 200, { workspace, sampleWorkspace, version: "0.7.2-dev", ingestion: ingestionCapabilities, watchMode });
